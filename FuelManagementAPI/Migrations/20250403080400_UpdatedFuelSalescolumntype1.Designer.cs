...
namespace FuelManagementAPI.Migrations
{
    ...
    [Migration("20250403080400_UpdatedFuelSalescolumntype1")]
    partial class UpdatedFuelSalescolumntype1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FuelManagementAPI.Models.LubeSale", b =>
                {
                    ...
                    b.HasOne("FuelManagementAPI.Models.Product", "LubeProducts")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
